 ...
 * @returns {Object}
 */
ResolverMethodHandler.prototype.method = function (
  ensName,
  methodName,
  methodArguments,
  outputFormatter,
...
ResolverMethodHandler.prototype.call = function (callback) {
  ...
  var preparedArguments = this.parent.prepareArguments(
    this.ensName,
  ...
  this.parent.registry
    ...
    .then(async function (resolver) {
      ...
      self.parent.handleCall(
        promiEvent,
        resolver.methods[self.methodName],
        preparedArguments,
        outputFormatter,
        callback
      );
 ...
 * @returns {eventifiedPromise}
 */
ResolverMethodHandler.prototype.handleCall = function (
  promiEvent,
  method,
  preparedArguments,
  outputFormatter,
 ...
 * @returns {eventifiedPromise}
 */
ResolverMethodHandler.prototype.handleSend = function (
  promiEvent,
  method,
  preparedArguments,
  sendOptions,
 ...
 * @returns {array}
 */
ResolverMethodHandler.prototype.prepareArguments = function (
  name,
  methodArguments
) {
 ...
 * @returns {Promise}
 */
ResolverMethodHandler.prototype.checkInterfaceSupport = async function (
  resolver,
  methodName
) {
  ...
  var supported = false;
  try {
    supported = await resolver.methods
  ...
  if (!supported) {
    throw errors.ResolverMethodMissingError(
      resolver.options.address,
      methodName
    );
  }
