        ...
        request(
          ...
          function (err, arrayBuffer, response) {
            ...
            if (response.statusCode >= 400) {
              return reject(
                new Error("Error ".concat(response.statusCode, "."))
              );
            }
            ...
            var downloadEntry = function downloadEntry(entry) {
              if (entry.path === undefined) {
                ...
                return entry.contentType === "application/bzz-manifest+json"
                  ...
                  : Promise.resolve(
                      impureInsert(path + entry.path)(format(entry))(routes)
                    );
              }
  ...
  var downloadRoutes = function downloadRoutes(swarmUrl) {
    return function (hash) {
      return downloadEntries(swarmUrl)(hash).then(function (entries) {
        return toMap(Object.keys(entries))(
          Object.keys(entries).map(function (route) {
        ...
        return downloadRoutes(swarmUrl)(hash).then(function (routingTable) {
          ...
          for (var route in routingTable) {
            if (route.length > 0) {
              ...
              downloads.push(
                downloadDataToDisk(swarmUrl)(routingTable[route])(filePath)
              );
            }
          }
    ...
    return new Promise(function (resolve, reject) {
      ...
      var handleProcessOutput = function handleProcessOutput(data) {
        if (
          ...
          hasString(PASSWORD_PROMPT_HOOK)(data)
        ) {
          setTimeout(function () {
            state = STARTING;
  ...
  var local = function local(swarmSetup) {
    return function (useAPI) {
      return _isAvailable("http://localhost:8500").then(function (isAvailable) {
        return isAvailable
          ? useAPI(at("http://localhost:8500")).then(function () {})
